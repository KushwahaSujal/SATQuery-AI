  ...
  "models": [
    {
      ...
      "supported_modalities": ["optical_rgb", "multispectral"],
      ...
      "model_id": "general_rs_vlm",
      "family": "General RS Vision-Language Model"
    },
    {
      "name": "Grounding DINO",
      "version": "1.0",
...
- **Routing Logic Matrix**:
  ...
  | :--- | :--- | :--- | :--- |
  | Single Image | Natural Language VQA / Description | Single-Image VQA | General RS VLM (Unconfigured / Graceful Warning) |
