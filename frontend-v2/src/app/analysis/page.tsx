    ...
    <div className="h-screen w-full flex flex-col bg-[var(--canvas)] text-[var(--text-2)] font-sans overflow-hidden select-none antialiased">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {viewState === "initial" && (
          <>
            {/* Center Workspace */}
            <main className="flex-1 flex flex-col bg-[var(--surface-2)] overflow-y-auto px-6 py-4 space-y-4">
              {/* Hero Banner */}
              <section className="relative overflow-hidden rounded-2xl border border-[var(--border)] bg-gradient-to-r from-[var(--surface-2)] via-[var(--surface-3)] to-[var(--surface)] p-5 shrink-0">
                <div className="hero-glow-overlay absolute inset-0 pointer-events-none" />
                <div className="relative z-10 flex items-center justify-between">
                  {/* Left info */}
                  <div className="max-w-md space-y-2">
                    <div className="inline-flex items-center space-x-1.5 px-2 py-0.5 rounded-full bg-cyan-500/10 border border-[var(--cyan)]/30 text-[var(--cyan)] text-[10px] font-semibold">
                      <svg className="w-3 h-3 text-[var(--cyan)]" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                      <span>AI ASSISTANT</span>
                    </div>
                    <h1 className="text-xl font-bold text-[var(--heading)] tracking-tight">Your Satellite Intelligence Copilot</h1>
                  ...
                  <div className="relative w-56 h-28 shrink-0 flex items-center justify-end">
                    ...
                    <div className="relative w-28 h-28 rounded-full border border-[var(--cyan)]/20 bg-gradient-to-tr from-cyan-950/60 to-blue-900/40 shadow-[0_0_25px_rgba(6,182,212,0.2)] overflow-hidden">
                      <div className="absolute inset-0 opacity-40 bg-[radial-gradient(#38bdf8_1px,transparent_1px)] [background-size:8px_8px]" />
                      <div className="absolute top-4 right-3 w-14 h-14 border border-[var(--cyan)]/60 bg-cyan-500/20 rounded-lg transform -rotate-12 backdrop-blur-xs flex items-center justify-center">
                    ...
                    <div className="absolute -top-1 right-24 animate-pulse">
                      <div className="relative flex items-center">
                        <div className="w-3.5 h-6 bg-cyan-700/80 border border-[var(--cyan)] rounded-sm" />
                        <div className="w-4 h-4 bg-[var(--text-4)] border-2 border-[var(--cyan)] rounded-sm mx-0.5 shadow-md flex items-center justify-center">
                          <div className="w-1.5 h-1.5 bg-cyan-500 rounded-full" />
                        </div>
                        <div className="w-3.5 h-6 bg-cyan-700/80 border border-[var(--cyan)] rounded-sm" />
                        <div className="absolute -bottom-4 right-3 w-6 h-6 border-l border-b border-[var(--cyan)]/50 rounded-bl-full pointer-events-none" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-4 gap-3 mt-4 pt-4 border-t border-[var(--border)]">
                  <div onClick={() => handleStartAnalysis("Perform land cover image analysis")} className="p-2.5 rounded-xl bg-[var(--surface-2)]/90 border border-[var(--border)] hover:border-[var(--cyan)]/50 hover:bg-[var(--surface-hover)] transition cursor-pointer flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-lg bg-cyan-500/10 border border-[var(--cyan)]/30 flex items-center justify-center shrink-0">
                    ...
                    <div className="min-w-0">
                      <h4 className="text-xs font-semibold text-[var(--heading)] truncate">Image Analysis</h4>
                      <p className="text-[10px] text-[var(--text-3)] truncate">Understand what&apos;s in your imagery</p>
                    </div>
                  </div>

                  <div onClick={() => handleStartAnalysis("Extract bi-temporal change patterns")} className="p-2.5 rounded-xl bg-[var(--surface-2)]/90 border border-[var(--border)] hover:border-[var(--cyan)]/50 hover:bg-[var(--surface-hover)] transition cursor-pointer flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-lg bg-cyan-500/10 border border-[var(--cyan)]/30 flex items-center justify-center shrink-0">
                      <svg className="w-4 h-4 text-[var(--cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="min-w-0">
                      <h4 className="text-xs font-semibold text-[var(--heading)] truncate">Data Insights</h4>
                      <p className="text-[10px] text-[var(--text-3)] truncate">Find patterns and changes</p>
                    </div>
                  </div>

                  <div onClick={() => router.push("/reports")} className="p-2.5 rounded-xl bg-[var(--surface-2)]/90 border border-[var(--border)] hover:border-[var(--cyan)]/50 hover:bg-[var(--surface-hover)] transition cursor-pointer flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-lg bg-cyan-500/10 border border-[var(--cyan)]/30 flex items-center justify-center shrink-0">
                      <svg className="w-4 h-4 text-[var(--cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="min-w-0">
                      <h4 className="text-xs font-semibold text-[var(--heading)] truncate">Reports</h4>
                      <p className="text-[10px] text-[var(--text-3)] truncate">Generate detailed reports</p>
                    </div>
                  </div>

                  <div onClick={() => handleStartAnalysis("Fuse Sentinel-1 SAR with Sentinel-2 Optical")} className="p-2.5 rounded-xl bg-[var(--surface-2)]/90 border border-[var(--border)] hover:border-[var(--cyan)]/50 hover:bg-[var(--surface-hover)] transition cursor-pointer flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-lg bg-cyan-500/10 border border-[var(--cyan)]/30 flex items-center justify-center shrink-0">
                      <svg className="w-4 h-4 text-[var(--cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="min-w-0">
                      <h4 className="text-xs font-semibold text-[var(--heading)] truncate">Multi-Modal</h4>
                      <p className="text-[10px] text-[var(--text-3)] truncate">Combine optical + SAR</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="flex-1 flex flex-col items-center justify-center py-6 px-4">
                <div className="w-10 h-10 rounded-full bg-cyan-500/10 border border-[var(--cyan)]/30 flex items-center justify-center mb-3 glow-cyan-sm">
                  <svg className="w-5 h-5 text-[var(--cyan)]" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2l2.4 6.6L21 11l-6.6 2.4L12 20l-2.4-6.6L3 11l6.6-2.4L12 2z" />
                  </svg>
                </div>
                <h2 className="text-lg font-bold text-[var(--heading)] text-center">How can I help you today?</h2>
                <p className="text-xs text-[var(--text-3)] text-center max-w-md mt-1 mb-6">
                ...
                <div className="grid grid-cols-2 gap-3 w-full max-w-2xl">
                  {[
                    ...
                    <button
                      ...
                      className="flex items-center space-x-3 p-3 text-left rounded-xl bg-[var(--surface)] border border-[var(--border)] hover:border-[var(--cyan)]/40 hover:bg-[var(--surface-hover)] transition group"
                    >
                      <svg className="w-4 h-4 text-[var(--cyan)] shrink-0 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d={item.iconPath} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                      </svg>
                      <span className="text-xs text-[var(--text-2)] group-hover:text-[var(--heading)] font-medium">{item.text}</span>
                    </button>
                  ))}
                </div>
              </section>
              ...
              <div className="mt-auto pt-2 shrink-0">
                <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-3 shadow-lg">
                  ...
                  <div className="flex items-center space-x-3 pb-2.5">
                    <button onClick={() => fileRef.current?.click()} className="text-[var(--text-3)] hover:text-[var(--cyan)] transition p-1">
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-lg bg-gradient-to-r from-cyan-500 to-sky-500 flex items-center justify-center text-[var(--canvas)] font-bold hover:brightness-110 transition shadow-[0_0_10px_rgba(6,182,212,0.5)] cursor-pointer"
                    >
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-[var(--border)] text-[11px]">
                    <div className="flex items-center space-x-2">
                      <button onClick={() => fileRef.current?.click()} className="flex items-center space-x-1.5 px-2.5 py-1 rounded-md bg-[var(--surface-3)] border border-[var(--border)] text-[var(--text-2)] hover:text-[var(--heading)] hover:border-[var(--cyan)]/40 transition">
                      ...
                      <button onClick={() => router.push("/datasets")} className="flex items-center space-x-1.5 px-2.5 py-1 rounded-md bg-[var(--surface-3)] border border-[var(--border)] text-[var(--text-2)] hover:text-[var(--heading)] hover:border-[var(--cyan)]/40 transition">
                        <svg className="w-3.5 h-3.5 text-[var(--cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="relative">
                        <button className="flex items-center space-x-1.5 px-2.5 py-1 rounded-md bg-[var(--surface-3)] border border-[var(--border)] text-[var(--text-2)] hover:text-[var(--heading)] hover:border-[var(--cyan)]/40 transition">
                          <svg className="w-3.5 h-3.5 text-[var(--cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-[var(--text-3)] font-medium">Advanced</span>
                      <div
                        onClick={() => setAdvancedMode(!advancedMode)}
                        className={`w-8 h-4 rounded-full p-0.5 flex items-center cursor-pointer transition ${
                          advancedMode ? "bg-[var(--cyan)] justify-end" : "bg-[var(--surface-3)] border border-[var(--border-strong)] justify-start"
                        }`}
                      >
                        <div className="w-3 h-3 bg-[var(--text-3)] rounded-full" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between text-[10px] text-[var(--text-3)] mt-2 px-1">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 text-[var(--cyan)] hover:text-[var(--cyan)] bg-cyan-950/40 border border-cyan-800/50 px-2 py-0.5 rounded cursor-pointer transition"
                  >
            ...
            <aside className="w-[430px] bg-[var(--surface)] border-l border-[var(--border)] flex flex-col justify-between shrink-0">
              {/* Top Navigation Tabs */}
              <div className="border-b border-[var(--border)] px-4 pt-3 pb-2 flex items-center justify-between shrink-0">
                <div className="flex items-center space-x-6 text-xs font-semibold">
                  <button
                    onClick={() => setActiveTab("chat")}
                    className={`pb-2 -mb-2 px-1 transition ${activeTab === "chat" ? "text-[var(--cyan)] border-b-2 border-[var(--cyan)]" : "text-[var(--text-3)] hover:text-[var(--text)]"}`}
                  >
                    Chat
                  </button>
                  <button
                    onClick={() => setActiveTab("analysis")}
                    className={`pb-2 -mb-2 px-1 transition ${activeTab === "analysis" ? "text-[var(--cyan)] border-b-2 border-[var(--cyan)]" : "text-[var(--text-3)] hover:text-[var(--text)]"}`}
                  >
                    Analysis
                  </button>
                  <button
                    onClick={() => setActiveTab("trace")}
                    className={`pb-2 -mb-2 px-1 transition ${activeTab === "trace" ? "text-[var(--cyan)] border-b-2 border-[var(--cyan)]" : "text-[var(--text-3)] hover:text-[var(--text)]"}`}
                  >
                    Execution Trace
                  </button>
                </div>
                <button onClick={() => setViewState("ongoing")} title="Open Split Screen" className="text-[var(--text-3)] hover:text-[var(--heading)] transition p-1">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4 text-xs">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <div className="w-5 h-5 rounded-full bg-[var(--primary)] text-[var(--heading)] flex items-center justify-center font-bold text-[9px]">
                        SM
                      </div>
                      <span className="font-semibold text-[var(--heading)]">You</span>
                    </div>
                    <span className="text-[10px] text-[var(--text-3)]">11:42 AM</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[var(--surface-2)] border border-[var(--border)] text-[var(--text)] leading-relaxed">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <div className="w-5 h-5 rounded-md bg-gradient-to-tr from-cyan-400 to-blue-500 flex items-center justify-center text-[var(--canvas)] font-bold text-[9px] shadow-[0_0_8px_rgba(6,182,212,0.5)]">
                        <svg className="w-3 h-3 text-[var(--canvas)] transform -rotate-45" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                          <ellipse cx="12" cy="12" rx="10" ry="4" stroke="currentColor" />
                          <circle cx="12" cy="12" fill="currentColor" r="2" />
                        </svg>
                      </div>
                      <span className="font-semibold text-[var(--cyan)]">SatQuery AI</span>
                    </div>
                    <span className="text-[10px] text-[var(--text-3)]">11:44 AM</span>
                  </div>
                  ...
                  <div className="p-3.5 rounded-xl bg-[var(--surface)] border border-[var(--border)] space-y-3 leading-relaxed text-[var(--text-2)]">
                    ...
                    <div className="rounded-lg bg-[var(--surface-2)]/70 border border-[var(--border)] p-2.5 space-y-1.5">
                      <div className="flex items-center space-x-1.5 text-[var(--cyan)] font-semibold text-[11px]">
                      ...
                      <ul className="space-y-1 text-[var(--text-2)] pl-2 text-[11px]">
                        <li className="flex items-center space-x-1.5">
                          ...
                          <span>Vegetation loss: <strong className="text-[var(--heading)]">12.4%</strong> (≈ 2.8 km²)</span>
                        </li>
                        <li className="flex items-center space-x-1.5">
                          <span className="w-1 h-1 rounded-full bg-[var(--cyan)]" />
                          <span>New built-up area: <strong className="text-[var(--heading)]">8.7%</strong> (≈ 1.9 km²)</span>
                        </li>
                        <li className="flex items-center space-x-1.5">
                          <span className="w-1 h-1 rounded-full bg-[var(--cyan)]" />
                          <span>Water body change: <strong className="text-[var(--heading)]">+1.2%</strong> (≈ 0.3 km²)</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <ol className="space-y-1 text-[var(--text-2)] text-[11px] pl-4 list-decimal marker:text-[var(--text-3)]">
                    ...
                    <div className="pt-1">
                      <div className="flex space-x-2">
                        ...
                        <div className="flex-1">
                          <div className="relative rounded-lg overflow-hidden border border-[var(--border)] aspect-[4/3] bg-[var(--green-bg)]/40 group">
                            ...
                            <span className="absolute bottom-1 left-1 px-1.5 py-0.5 bg-[var(--scrim)] backdrop-blur-xs text-[9px] font-mono text-[var(--text)] rounded">
                              2022
                            </span>
                          </div>
                        </div>
                        ...
                        {/* Legend pills column */}
                        <div className="w-24 space-y-1 shrink-0 text-[9px] text-[var(--text-2)] flex flex-col justify-center">
                          <div className="flex items-center space-x-1.5">
                            <span className="w-2 h-2 rounded-xs bg-[var(--error)]" />
                            <span>Built-up area</span>
                          </div>
                          <div className="flex items-center space-x-1.5">
                            <span className="w-2 h-2 rounded-xs bg-[var(--warning)]" />
                      ...
                      <button
                        onClick={() => setViewState("ongoing")}
                        className="w-full mt-2.5 py-1.5 px-3 rounded-lg bg-[var(--surface-3)] border border-[var(--border-strong)] hover:border-[var(--cyan)]/50 hover:bg-[var(--surface-hover)] transition text-[var(--cyan)] text-[11px] font-medium flex items-center justify-center space-x-1.5 cursor-pointer shadow-sm"
                      >
                  ...
                  <div className="rounded-xl bg-[var(--surface)] border border-[var(--border)] overflow-hidden">
                    <div
                      ...
                      className="p-2.5 flex items-center justify-between border-b border-[var(--border)] cursor-pointer hover:bg-[var(--surface-hover)]"
                    >
                      <div className="flex items-center space-x-2 text-[var(--cyan)] text-xs font-semibold">
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <circle cx="12" cy="12" r="3" strokeWidth="2" />
                          <path d="M19 12a7 7 0 11-14 0 7 7 0 0114 0z" strokeLinecap="round" strokeWidth="2" />
                        </svg>
                      ...
                      <svg className={`w-3.5 h-3.5 text-[var(--text-3)] transition-transform ${relatedOpen ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d="M19 9l-7 7-7-7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                      </svg>
                    </div>
                    {relatedOpen && (
                      <div className="divide-y divide-[#122338] text-[11px]">
                        <div onClick={() => setViewState("ongoing")} className="p-2.5 flex items-center justify-between hover:bg-[var(--surface-hover)] cursor-pointer text-[var(--text-2)] hover:text-[var(--heading)] transition">
                          <div className="flex items-center space-x-2">
                            <svg className="w-3.5 h-3.5 text-[var(--cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <rect height="18" rx="2" strokeWidth="2" width="18" x="3" y="3" />
                              <circle cx="8.5" cy="8.5" fill="currentColor" r="1.5" />
                        ...
                        <div onClick={() => router.push("/reports")} className="p-2.5 flex items-center justify-between hover:bg-[var(--surface-hover)] cursor-pointer text-[var(--text-2)] hover:text-[var(--heading)] transition">
                          <div className="flex items-center space-x-2">
                            <svg className="w-3.5 h-3.5 text-[var(--cyan)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            </svg>
              ...
              <div className="p-3 border-t border-[var(--border)] bg-[var(--surface)] shrink-0">
                <div className="flex items-center space-x-2">
                  <button onClick={() => fileRef.current?.click()} className="p-2 rounded-lg bg-[var(--surface-2)] border border-[var(--border)] text-[var(--text-3)] hover:text-[var(--heading)] transition">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="relative flex-1 flex items-center">
                    <input
                      ...
                      className="w-full h-9 px-3 pr-10 text-xs bg-[var(--surface-2)] border border-[var(--border)] rounded-lg text-[var(--text)] placeholder-[var(--text-3)] focus:outline-none focus:border-[var(--cyan)] transition"
                      placeholder="Ask a follow-up question..."
                      type="text"
                    />
                    <button
                      onClick={() => handleStartAnalysis(followUp)}
                      className="absolute right-1.5 w-6 h-6 rounded bg-gradient-to-r from-cyan-500 to-sky-500 flex items-center justify-center text-[var(--canvas)] font-bold hover:brightness-110 transition cursor-pointer"
                    >
          ...
          <>
            ...
            <main className="flex-1 flex flex-col bg-[var(--surface)] overflow-hidden border-r border-[var(--border)]">
              ...
              <div className="px-5 py-3 border-b border-[var(--border)] bg-[var(--surface)] flex flex-col gap-2 shrink-0">
                <div className="flex items-center justify-between">
                  <div>
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs text-[var(--text-3)] hover:text-[var(--cyan)] transition cursor-pointer"
                    >
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center gap-2.5 mt-1">
                      <h1 className="text-lg font-bold text-[var(--heading)] tracking-tight">Urban Expansion Analysis</h1>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => router.push("/reports")} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[var(--border)] bg-[var(--surface-3)] hover:bg-[var(--surface-hover)] text-xs font-medium text-[var(--text)] transition">
                      <svg className="w-3.5 h-3.5 text-[var(--text-3)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    ...
                    <button className="p-1.5 rounded-lg border border-[var(--border)] bg-[var(--surface-3)] hover:bg-[var(--surface-hover)] text-[var(--text-3)] hover:text-[var(--heading)] transition">
                ...
                <div className="flex items-center gap-3 text-xs text-[var(--text-3)]">
                  ...
                  <div className="flex items-center gap-1.5 text-[var(--text-3)] ml-1">
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <circle cx="12" cy="12" r="10" />
              ...
              <div className="h-11 px-4 border-b border-[var(--border)] bg-[var(--surface)] flex items-center justify-between text-xs shrink-0">
                ...
                <div className="flex items-center gap-1 text-[var(--text-3)]">
                  <button className="p-1.5 hover:text-[var(--text)] hover:bg-[var(--surface-hover)] rounded transition">
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <path d="M12 20h9" />
                      <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" />
                    </svg>
              ...
              <div ref={containerRef} className="relative flex-1 bg-[var(--scrim)] overflow-hidden flex select-none">
                ...
                <div className="absolute left-3 top-3 z-20 w-52 bg-[var(--surface)]/90 backdrop-blur-md rounded-lg border border-[var(--border)] shadow-2xl p-2.5 text-xs select-none">
                  {/* Layer Tabs */}
                  <div className="flex border-b border-[var(--border)] mb-2.5 pb-1">
                    <button
                      onClick={() => setLayerTab("images")}
                      className={`flex-1 text-center py-1 font-semibold text-[11px] transition ${
                        layerTab === "images" ? "text-[var(--cyan)] border-b-2 border-[var(--cyan)]" : "text-[var(--text-3)] hover:text-[var(--text)]"
                      }`}
                    >
                      Images
                    </button>
                    <button
                      ...
                      className={`flex-1 text-center py-1 text-[11px] transition ${
                        layerTab === "layers" ? "text-[var(--cyan)] border-b-2 border-[var(--cyan)]" : "text-[var(--text-3)] hover:text-[var(--text)]"
                      }`}
                    >
                      Layers
                    </button>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-1.5 rounded-md bg-[var(--surface-3)] border border-cyan-900/50">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="text-[11px] font-semibold text-[var(--text)] leading-tight">T1 - 2023-01-15</div>
                          <div className="text-[9px] text-[var(--text-3)]">Optical (Sentinel-2)</div>
                        </div>
                      </div>
                      <button onClick={() => setT1Visible(!t1Visible)} className={t1Visible ? "text-[var(--cyan)] hover:text-[var(--cyan)]" : "text-[var(--text-2)]"}>
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center justify-between p-1.5 rounded-md bg-[var(--surface-3)] border border-[var(--border)]">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded bg-[var(--green-bg)] overflow-hidden border border-red-500/50 relative">
                          <div className="w-full h-full satellite-bg-base scale-150" />
                          <div className="absolute inset-0 bg-red-500/20" />
                        </div>
                        <div>
                          <div className="text-[11px] font-semibold text-[var(--text)] leading-tight">T2 - 2025-01-18</div>
                          <div className="text-[9px] text-[var(--text-3)]">Optical (Sentinel-2)</div>
                        </div>
                      </div>
                      <button onClick={() => setT2Visible(!t2Visible)} className={t2Visible ? "text-[var(--cyan)] hover:text-[var(--cyan)]" : "text-[var(--text-2)]"}>
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                          <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                          <circle cx="12" cy="12" r="3" />
                        </svg>
                  ...
                  <div className="mt-3 pt-2.5 border-t border-[var(--border)]">
                    <span className="text-[10px] uppercase font-semibold text-[var(--text-3)] tracking-wider">Additional Layers</span>
                    <div className="mt-2 space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className="text-[11px] text-[var(--text-2)] flex items-center gap-1.5">
                        ...
                        <div
                          ...
                          className={`w-7 h-4 rounded-full p-0.5 cursor-pointer flex items-center transition ${
                            layersToggle.changeDetection ? "bg-[var(--cyan)] justify-end" : "bg-[var(--surface-hover)] border border-[var(--border-strong)] justify-start"
                          }`}
                        >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div
                          ...
                          className={`w-7 h-4 rounded-full p-0.5 cursor-pointer flex items-center transition ${
                            layersToggle.urbanArea ? "bg-[var(--cyan)] justify-end" : "bg-[var(--surface-hover)] border border-[var(--border-strong)] justify-start"
                          }`}
                        >
                          <div className="w-3 h-3 rounded-full bg-[var(--text-3)] shadow-sm" />
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div
                          ...
                          className={`w-7 h-4 rounded-full p-0.5 cursor-pointer flex items-center transition ${
                            layersToggle.vegetation ? "bg-[var(--cyan)] justify-end" : "bg-[var(--surface-hover)] border border-[var(--border-strong)] justify-start"
                          }`}
                        >
                          <div className="w-3 h-3 rounded-full bg-[var(--text-3)] shadow-sm" />
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div
                          ...
                          className={`w-7 h-4 rounded-full p-0.5 cursor-pointer flex items-center transition ${
                            layersToggle.waterBodies ? "bg-[var(--cyan)] justify-end" : "bg-[var(--surface-hover)] border border-[var(--border-strong)] justify-start"
                          }`}
                        >
                          <div className="w-3 h-3 rounded-full bg-[var(--text-3)] shadow-sm" />
                        </div>
                ...
                <div className="relative w-full h-full flex overflow-hidden">
                  ...
                  >
                    ...
                    {/* T1 Timestamp Tag */}
                    <div className="absolute top-3 left-60 bg-[var(--surface)]/80 backdrop-blur border border-[var(--border)] px-2.5 py-1 rounded text-[11px] font-medium text-[var(--text)] z-10 shadow-md">
                      T1 - 2023-01-15
                    </div>

                    {/* Distance Scale Indicator */}
                    <div className="absolute bottom-4 left-4 z-10 flex flex-col gap-1 bg-[var(--surface)]/85 backdrop-blur px-2.5 py-1.5 rounded border border-[var(--border)]">
                      <div className="flex justify-between text-[9px] font-mono text-[var(--text-2)] w-28">
                        <span>0</span>
                        <span>0.5</span>
                        <span>1km</span>
                      </div>
                      <div className="h-1 w-28 bg-[var(--text-4)] flex">
                  ...
                  <div className="absolute right-4 bottom-6 z-20 flex flex-col gap-1.5">
                    <div className="flex flex-col bg-[var(--surface)]/90 backdrop-blur rounded-lg border border-[var(--border)] overflow-hidden shadow-xl">
                      <button className="w-7 h-7 flex items-center justify-center text-[var(--text-2)] hover:text-[var(--heading)] hover:bg-[var(--surface-hover)] text-sm font-bold border-b border-[var(--border)] cursor-pointer">+</button>
                      <button className="w-7 h-7 flex items-center justify-center text-[var(--text-2)] hover:text-[var(--heading)] hover:bg-[var(--surface-hover)] text-sm font-bold cursor-pointer">-</button>
                    </div>
                    <button className="w-7 h-7 rounded-lg bg-[var(--surface)]/90 backdrop-blur border border-[var(--border)] flex items-center justify-center text-[var(--text-2)] hover:text-[var(--heading)] shadow-xl cursor-pointer">
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    ...
                    <div className="w-7 h-7 rounded-lg bg-[var(--surface)]/90 backdrop-blur border border-[var(--border)] flex items-center justify-center text-xs font-bold text-[var(--error)] shadow-xl">
                      <svg className="w-4 h-4 text-[var(--error)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <div className="h-20 border-t border-[var(--border)] bg-[var(--surface)] px-4 flex items-center gap-3 shrink-0">
                <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-[var(--surface-2)] border border-[var(--cyan)]/70/60 shadow-md cursor-pointer">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 text-[10px] text-[var(--text-3)] mt-0.5">
                      <svg className="w-3 h-3 text-[var(--cyan)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                        <circle cx="12" cy="12" r="3" />
                      </svg>
                ...
                <button
                  ...
                  className="h-14 px-4 rounded-lg border-2 border-dashed border-[var(--border)] hover:border-[var(--cyan)]/60 bg-[var(--surface)] flex flex-col items-center justify-center text-[var(--text-3)] hover:text-[var(--cyan)] transition cursor-pointer"
                >
            ...
            <aside className="w-[420px] bg-[var(--surface)] flex flex-col shrink-0 select-text overflow-hidden">
              ...
              <div className="h-11 px-4 border-b border-[var(--border)] bg-[var(--surface)] flex items-center justify-between shrink-0">
                ...
                <button title="Maximize view" className="text-[var(--text-3)] hover:text-[var(--heading)] p-1 rounded">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <>
                    ...
                    <div className="flex items-start gap-2.5">
                      <div className="w-6 h-6 rounded-full bg-[var(--surface-3)] flex items-center justify-center text-[10px] font-bold text-[var(--heading)] shrink-0 mt-0.5">
                        <svg className="w-3.5 h-3.5 text-[var(--text-2)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      ...
                      <div className="flex-1 space-y-3">
                        <div>
                          <div className="flex items-center gap-2 mb-1.5">
                            <span className="font-semibold text-[var(--heading)]">SatQuery AI</span>
                            <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-400 bg-[var(--green-bg)]/60 px-2 py-0.5 rounded-full border border-emerald-800/40">
                              <svg className="w-2.5 h-2.5" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
                          ...
                          <div className="mt-2 text-[var(--text-2)] space-y-1">
                            <p className="font-medium text-[var(--text)]">Major changes include:</p>
                            <ul className="space-y-1 pl-1 text-[var(--text-2)]">
                              <li className="flex items-center gap-1.5"><span className="text-[var(--cyan)]">•</span> New built-up structures (residential/commercial)</li>
                              <li className="flex items-center gap-1.5"><span className="text-[var(--cyan)]">•</span> Expansion of road network</li>
                              <li className="flex items-center gap-1.5"><span className="text-[var(--cyan)]">•</span> Reduction in vegetation cover</li>
                            </ul>
                          </div>
                        ...
                        <div className="p-2 rounded-lg bg-[var(--surface-2)] border border-[var(--border)]">
                          <div className="flex items-center justify-between text-[11px] mb-1.5">
                            ...
                            <span className="font-bold text-[var(--cyan)] font-mono">87%</span>
                          </div>
                        ...
                        <div className="rounded-lg bg-[var(--surface-2)] border border-[var(--border)] p-3 space-y-2.5">
                          <div className="flex items-center justify-between">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <div>
                              <div className="h-20 rounded bg-[var(--green-bg)] border border-[var(--border)] relative overflow-hidden">
                                <div className="w-full h-full satellite-bg-base scale-125" />
                              </div>
                              <span className="text-[10px] text-[var(--text-3)] mt-1 block">2023</span>
                            </div>
                            <div>
                              <div className="h-20 rounded bg-[var(--green-bg)] border border-red-500/50 relative overflow-hidden">
                                <div className="w-full h-full satellite-bg-base scale-125" />
                                <div className="absolute inset-0 bg-red-500/25" />
                              </div>
                              <span className="text-[10px] text-[var(--text-3)] mt-1 block">2025</span>
                            </div>
                          </div>
                          {/* Legend */}
                          <div className="space-y-1 pt-1 text-[10px] text-[var(--text-3)] border-t border-[var(--border)]">
                            <div className="flex items-center justify-between">
                          ...
                          <button className="w-full py-1.5 rounded bg-[var(--surface-3)] hover:bg-[var(--surface-hover)] border border-[var(--border-strong)] text-[11px] font-medium text-[var(--text)] flex items-center justify-center gap-1.5 transition cursor-pointer">
                        ...
                        <div className="rounded-lg bg-[var(--surface)] border border-[var(--border)] p-3">
                          <span className="text-[11px] font-semibold text-[var(--text-2)] flex items-center gap-1.5 mb-2">
                            <svg className="w-3.5 h-3.5 text-[var(--cyan)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                          ...
                          <div className="space-y-1.5 text-[10px]">
                            <div className="flex items-center justify-between text-[var(--text-2)]">
                              ...
                              <span className="text-[var(--text-3)] font-mono">→ Change-based VQA</span>
                            </div>
                            <div className="flex items-center justify-between text-[var(--text-2)]">
                              <span className="flex items-center gap-1.5">
                                <span className="text-emerald-400">✓</span> Input validated
                              </span>
                              <span className="text-[var(--text-3)] font-mono">→ 2 images, Optical + Optical</span>
                            </div>
                            <div className="flex items-center justify-between text-[var(--text-2)]">
                              <span className="flex items-center gap-1.5">
                                <span className="text-emerald-400">✓</span> Specialist selected
                              </span>
                              <span className="text-[var(--text-3)] font-mono">→ Change Analysis Model</span>
                            </div>
                            <div className="flex items-center justify-between text-[var(--text-2)]">
                              <span className="flex items-center gap-1.5">
                                <span className="text-emerald-400">✓</span> Analysis executed
                              </span>
                              <span className="text-[var(--text-3)] font-mono">→ Change regions identified</span>
                            </div>
                            <div className="flex items-center justify-between text-[var(--text-2)]">
                              <span className="flex items-center gap-1.5">
                                <span className="text-emerald-400">✓</span> Evidence generated
                              </span>
                              <span className="text-[var(--text-3)] font-mono">→ Visual + Spatial results</span>
                            </div>
                            <div className="flex items-center justify-between text-[var(--text-2)]">
                              <span className="flex items-center gap-1.5">
                                <span className="text-emerald-400">✓</span> Response synthesized
                              </span>
                              <span className="text-[var(--text-3)] font-mono">→ Natural language answer</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 pt-1">
                          <button onClick={() => router.push("/reports")} className="flex-1 py-1.5 px-3 rounded-lg bg-[var(--surface-3)] hover:bg-[var(--surface-hover)] border border-[var(--border)] text-xs font-medium text-[var(--text)] flex items-center justify-center gap-1.5 transition cursor-pointer">
                            <svg className="w-3.5 h-3.5 text-[var(--text-3)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                          ...
                          <button className="flex-1 py-1.5 px-3 rounded-lg bg-[var(--surface-3)] hover:bg-[var(--surface-hover)] border border-[var(--border)] text-xs font-medium text-[var(--text)] flex items-center justify-center gap-1.5 transition cursor-pointer">
                            <svg className="w-3.5 h-3.5 text-[var(--text-3)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                          ...
                          <button className="p-1.5 rounded-lg bg-[var(--surface-3)] hover:bg-[var(--surface-hover)] border border-[var(--border)] text-[var(--text-3)] transition">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                              <circle cx="12" cy="12" r="1" />
                              <circle cx="19" cy="12" r="1" />
                              <circle cx="5" cy="12" r="1" />
                    ...
                    <div className="p-3 rounded-lg bg-[var(--surface-2)] border border-[var(--border)]">
                      ...
                      <div className="space-y-2 text-[11px]">
                        <div className="flex justify-between">
                          <span className="text-[var(--text-3)]">Total Analyzed Area:</span>
                          <span className="text-[var(--text)] font-mono">22.6 km²</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[var(--text-3)]">Changed Area:</span>
                          <span className="text-[var(--cyan)] font-mono">4.7 km² (20.8%)</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[var(--text-3)]">New Construction:</span>
                          <span className="text-red-400 font-mono">1.9 km²</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[var(--text-3)]">Vegetation Depletion:</span>
                          <span className="text-amber-400 font-mono">2.8 km²</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[var(--text-3)]">Cloud Obstruction:</span>
                          <span className="text-[var(--text-3)] font-mono">0.0% (Clear)</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="p-3 border-t border-[var(--border)] bg-[var(--surface)] shrink-0">
                <div className="relative bg-[var(--surface-2)] rounded-xl border border-[var(--border)] focus-within:border-[var(--cyan)]/70 p-2.5 shadow-inner">
                  <div className="flex items-center gap-2">
                    <button onClick={() => fileRef.current?.click()} className="text-[var(--text-3)] hover:text-[var(--text)]">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center justify-between mt-2.5 pt-2 border-t border-[var(--border)]">
                    <div className="flex items-center gap-1.5">
                      <button onClick={() => fileRef.current?.click()} className="px-2 py-1 rounded bg-[var(--surface-3)] hover:bg-[var(--surface-hover)] text-[10px] text-[var(--text-2)] flex items-center gap-1 border border-[var(--border)]">
                        <svg className="w-3 h-3 text-[var(--text-3)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                          <rect height="18" rx="2" width="18" x="3" y="3" />
                          <circle cx="8.5" cy="8.5" r="1.5" />
                          <polyline points="21 15 16 10 5 21" />
                      ...
                      <button className="px-2 py-1 rounded bg-[var(--surface-3)] hover:bg-[var(--surface-hover)] text-[10px] text-[var(--text-2)] flex items-center gap-1 border border-[var(--border)]">
                        <svg className="w-3 h-3 text-[var(--text-3)]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                          <rect height="18" rx="2" width="20" x="2" y="3" />
                          <line x1="12" x2="12" y1="3" y2="21" />
                        </svg>
                    ...
                    <button
                      onClick={() => setFollowUp("")}
                      className="w-7 h-7 rounded-lg bg-cyan-500 hover:bg-[var(--cyan)] text-[var(--canvas)] flex items-center justify-center font-bold shadow-md shadow-cyan-500/25 transition cursor-pointer"
                    >
