...
const FLUX_FROM = "var(--flux-from, #06b6d4)";
const FLUX_TO = "var(--flux-to, #0ea5e9)";
...
function FluxLabel({ label, reduced, className }: FluxLabelProps) {
  const base = cn(
    "absolute inset-0 flex items-center justify-center text-center text-sm font-semibold tracking-tight text-[var(--cyan)]",
    className,
  );
